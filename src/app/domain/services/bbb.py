...
class BBBService:
    async def set_hook(
        ...
        request = (
            f'{settings.BBB_API_URL}/hooks/create?{query_string}&checksum={checksum}'
        )
    ...
    async def list_hooks(
        ...
        request = (
            f'{settings.BBB_API_URL}/hooks/list?{query_string}&checksum={checksum}'
        )
    ...
    async def destroy_hook(
        ...
        request = (
            f'{settings.BBB_API_URL}/hooks/destroy?{query_string}&checksum={checksum}'
        )
